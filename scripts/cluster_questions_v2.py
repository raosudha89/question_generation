...
def extract_questions(posts_file, comments_file):
	...
	return questions, post_titles, post_bodies
...
def cluster_question_sentences(questions, post_titles, post_bodies, word_vectors, cluster_algo):
	...
	if cluster_algo == "kmeans":
		...
		dbscan = DBSCAN(eps=0.6, min_samples=1, n_jobs=-1).fit(question_sentence_vectors)
...
if __name__ == "__main__":
	...
	questions, post_titles, post_bodies = extract_questions(posts_file, comments_file)
	cluster_question_sentences(questions, post_titles, post_bodies, word_vectors, cluster_algo)		
