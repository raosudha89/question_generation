...
def build_baseline(word_embeddings, len_voc, word_emb_dim, N, args, freeze=False):
	...
	all_params = post_lstm_params + post_emb_params + ques_lstm_params + ques_emb_params \
...
def validate(val_fn, fold_name, epoch, fold, args):
	...
	#if True:
		#p, pm, q, qm, l = post_sents[:1], post_sent_masks[:1], ques_list[:1], ques_masks_list[:1], labels[:1]
